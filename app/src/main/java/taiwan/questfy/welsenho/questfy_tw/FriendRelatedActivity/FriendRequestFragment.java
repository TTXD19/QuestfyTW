...
public class FriendRequestFragment extends Fragment {
    ...
    private void InitItem() {
        ...
        adapter = new FriendRequestRecyclerAdapter(arrayList, getContext(), new FriendRequestRecyclerAdapter.userImageClick() {
            @Override
            public void checkUserProfile(int position, ArrayList<FirebaseDatabaseGetSet> arrayList) {
                Intent intent = new Intent(getContext(), OtherUserProfileActivity.class);
                intent.putExtra("otherUserUid", arrayList.get(position).getSenderUid());
                startActivity(intent);
            }
        });
        ...
        adapter.setOnMainClickListener(new onMainFriendRequestClickListener() {
            ...
            public void onClicked(int position, ArrayList<FirebaseDatabaseGetSet> arrayList) {
                ...
                hashMap.put("FriendImage", arrayList.get(position).getRequestUserImage());
                ...
                hashMapFriend.put("FriendImage", firebaseUser.getPhotoUrl().toString());
